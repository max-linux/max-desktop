...
ITEMS=[
["Thunderbird", "http://www.tcosproject.org/max/max-win32-apps/Thunderbird_Setup_2.0.0.9.exe", "max-win32-apps/disctree/programs/thunderbird/Thunderbird_Setup_2.0.0.12.exe"],
...
["Firefox", "http://www.tcosproject.org/max/max-win32-apps/Firefox_Setup_2.0.0.13.exe", "max-win32-apps/disctree/programs/firefox/Firefox_Setup_2.0.0.13.exe"],
...
["OpenOffice.org", "http://www.tcosproject.org/max/max-win32-apps/OOo_2.4.0_Win32Intel_install_wJRE_es.exe", "max-win32-apps/disctree/programs/OpenOfice/OOo_2.4.0_Win32Intel_install_wJRE_es.exe"],
