...
#include <QDialog>
#include "ui_preferencesSQL.h"

/**
	@author Oscar Campos Ruiz-Adame <oscar.campos@edmanufacturer.es>
*/
class PreferencesSQLDialog : public QDialog, public Ui::preferencesSQL
{
     Q_OBJECT
public:
     PreferencesSQLDialog(QWidget *parent=0);
     
private slots:
     void onComboBoxChanged(QString);     
